    ...
    return (
        <footer className="footer" ref={footerRef}>
            ...
            <div className="footer__top wrap">
                <div className="footer__brand-col reveal">
            ...
            {/* Social band */}
            <div className="footer__social-band wrap reveal reveal-delay-1">
                ...
                <div className="footer__socials">
                    {[
                        ...
                        <a key={name} href={href} target="_blank" rel="noopener noreferrer" className="footer__social" aria-label={name}>
                            {icon}
                            <span>{name}</span>
                        </a>
                    ))}
                ...
                <div className="footer__bottom-inner wrap">
                    ...
                    <ul className="footer__legal">
                        {['Privacy Policy', 'Cookie Policy', 'Terms and Conditions', 'Cookie Settings'].map((t) => (
                            <li key={t}><Link to={`/${t.toLowerCase().replace(/ /g, '-')}`}>{t}</Link></li>
                        ))}
                    </ul>
                </div>
            </div>
