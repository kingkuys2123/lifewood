...
const SOCIALS = [
    {
        name: 'LinkedIn', href: 'https://www.linkedin.com/company/lifewood-data-technology-ltd./posts/?feedView=all',
    ...
    {
        name: 'Facebook', href: 'https://www.facebook.com/LifewoodPH',
    ...
    {
        name: 'Instagram', href: 'https://www.instagram.com/lifewood_official/?hl=af',
    ...
    {
        name: 'YouTube', href: 'https://www.youtube.com/@LifewoodDataTechnology',
